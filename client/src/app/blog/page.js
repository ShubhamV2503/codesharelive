...
const BLOG_POSTS = [
    {
        ...
        excerpt: "Building a zero-latency cursor engine isn't just about WebSockets. Read about our journey overcoming network jitter, resolving state collisions, and ensuring a seamless pair programming experience for distributed teams.",
        author: "Smith Shah",
        authorInitials: "SS",
        date: "May 10, 2026",
        readTime: "8 min read",
    ...
    },
    {
        ...
        excerpt: "Executing arbitrary user code safely in the browser required a paradigm shift. Discover our multi-layered isolation strategy utilizing custom isolated environments to prevent malicious execution while maintaining high performance.",
        author: "Priya Patel",
        authorInitials: "PP",
        date: "April 28, 2026",
        readTime: "6 min read",
    ...
    },
    {
        ...
        excerpt: "The wait is over! CodeshareLive 2.0 brings an interactive infinite canvas whiteboard and expands our native code execution engine to support over 15 modern programming languages including Rust, Go, and Python.",
    ...
    },
    {
        ...
        excerpt: "Pair programming is more than just sharing a screen. Learn effective communication strategies, how to divide driver/navigator roles, and how to use CodeshareLive to supercharge your collaborative workflow.",
    ...
    },
    {
        ...
        excerpt: "A comprehensive guide for hiring managers and recruiters. Learn how to set up pre-configured interview rooms, provide boilerplate challenges, and effectively evaluate candidate problem-solving in real-time.",
        author: "Riya Desai",
        authorInitials: "RD",
        date: "Jan 12, 2026",
        readTime: "4 min read",
    ...
    },
    {
        ...
        excerpt: "We've heavily optimized our core WebSocket mesh architecture and resolved critical edge cases causing cursor desynchronization on slow connections. Read the full changelog for a breakdown of all backend improvements.",
